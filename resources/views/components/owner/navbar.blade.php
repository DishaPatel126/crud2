        ...
        <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 ">
            ...
            @if (Auth::user() !== null)
                <div class="hidden space-x-2 md:block ">
                    ...
                    <a
                        class="rounded-md bg-transparent px-3 py-2 text-lg font-semibold text-honeydew bg-[#EE6C4D] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black ">
                        {{ Auth::user()->name }}
                    </a>
                </div>
            @else
